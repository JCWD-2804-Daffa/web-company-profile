          ...
          <div className='grid xs:grid-cols-1 sm:grid-cols-3 gap-10'>
            {
              listTeam.map((item:any, index:number) => {
                return (
                  <div key={index} className='bg-black text-white text-center p-10 rounded-lg flex flex-col gap-5'>
                    <h3 className='text-xl font-bold'>{item.name.first} {item.name.last}</h3>
