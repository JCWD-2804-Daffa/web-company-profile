  ...
  return (
    <div className='flex justify-between items-center gap-7 p-7 bg-black text-white sticky top-0 sm:px-20'>
        ...
        <ul className='flex justify-end text-center items-center gap-7'>
            ...
            <li className={`${pathname == "/about" && "bg-white rounded text-black p-2"}`}>
                <Link href="/about">About Us</Link>
            </li>
            <li className={`${pathname == "/services" && "bg-white rounded text-black p-2"}`}>
                <Link href="/services">Services</Link>
            </li>
            <li className={`${pathname == "/teams" && "bg-white rounded text-black p-2"}`}>
